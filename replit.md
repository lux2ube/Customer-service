...
**Record Immutability**: Once a record is Confirmed (has journal entries), the amount and amount_usd fields become immutable. Users cannot edit these values - they are locked to maintain accounting integrity. The UI disables amount fields for confirmed records with a visual indicator.
