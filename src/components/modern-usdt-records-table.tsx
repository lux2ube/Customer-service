    ...
    return records.filter(r => {
        ...
        if (search) {
            ...
            return (
                ...
                (r.clientWalletAddress && r.clientWalletAddress.toLowerCase().includes(lowercasedSearch)) ||
                (r.txHash && r.txHash.toLowerCase().includes(lowercasedSearch)) ||
        ...
        <div className="rounded-md border bg-card">
            ...
            <TableHeader>
                <TableRow>
                    ...
                    <TableHead>System Wallet</TableHead>
            ...
            <TableBody>
                ...
                filteredRecords.map((record) => (
                                    ...
                                    {record.txHash && (
                                        <DropdownMenuItem asChild>
                                            <a href={`https://bscscan.com/tx/${record.txHash}`} target="_blank" rel="noopener noreferrer">
                                                <ExternalLink className="mr-2 h-4 w-4" /> View on BSCScan
                                            </a>
                                        </DropdownMenuItem>
                                    )}
                    ...
                    <TableRow><TableCell colSpan={8} className="h-24 text-center">No records found for the selected criteria.</TableCell></TableRow>
                )}
            </TableBody>
            </Table>
        </div>
