...
export function Invoice({ transaction, client, company }: InvoiceProps) {
    ...
    return (
        <div className="max-w-4xl mx-auto font-sans">
             <div ref={invoiceRef} className="bg-white p-8 md:p-12 rounded-lg shadow-lg invoice-container">
                <style jsx global>{`
                    @media print {
                        body {
            ...
            <div className="no-print mt-10 text-center flex items-center justify-center gap-4">
