...
export default function FixAccount7000Page() {
    ...
    return (
        <div className="space-y-6">
            <Card>
                <CardHeader>
                    <CardTitle>Fix Account 7000</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                    {loading ? (
                        <div className="flex items-center gap-2">
                            <div className="animate-spin">⏳</div>
                            <span>Fixing account 7000...</span>
                        </div>
                    ) : result?.success ? (
                        <div className="flex items-start gap-3 p-4 bg-green-50 rounded-lg border border-green-200">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-green-800 mt-1">Account 7000 is now a posting account (not a group). Journal entries will now affect its balance.</p>
                            </div>
                        </div>
                    ) : (
